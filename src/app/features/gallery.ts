...
export class Gallery {
  ...
  readonly tags = ['All', 'Plantation', 'Seeds', 'Sapling', 'Community', 'Care'];
  ...
  readonly items: GalleryItem[] = [
    ...
    { tag: 'Sapling', caption: 'Free Sapling Distribution', date: 'Mar 2026', color: '#FEE2E2' },
    ...
    { tag: 'Sapling', caption: 'Gorewada Sapling Drive', date: 'Oct 2025', color: '#E0F2FE' },
